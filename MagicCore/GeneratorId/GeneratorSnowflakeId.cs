...
/// </para>
/// </summary>
public class GeneratorSnowflakeId : IGeneratorId
{
    #region 属性
    ...
    public GeneratorSnowflakeId(IConfiguration configuration)
    {
        WorkerId = configuration.GetValue<long>("Snowflake:WorkId", 1);
        DatacenterId = configuration.GetValue<long>("Snowflake:DatacenterId", 1);
        _twepoch = (long)(configuration.GetValue<DateTime>("Snowflake:TwepochTime", new DateTime(2020, 1, 1)).ToUniversalTime() - Jan1st1970).TotalMilliseconds;
